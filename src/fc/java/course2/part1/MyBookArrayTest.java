...
public class MyBookArrayTest {
    public static void main(String[] args) {
        ...
        //vo=list.get(1);
        System.out.println(list.get(1)); // vo.toString() : Book{title='C++', price=17000, company='대림', author='이길동'}

        //vo=list.get(2);
        System.out.println(list.get(2)); // vo.toString() : Book{title='Python', price=16000, company='정보', author='나길동'}
